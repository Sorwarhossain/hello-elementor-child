...
add_action('wp_ajax_vsc_load_catup_products', 'vsc_load_catup_products_ajax_handler'); 
add_action('wp_ajax_nopriv_vsc_load_catup_products', 'vsc_load_catup_products_ajax_handler');
...
add_action('wp_ajax_vsc_get_cat_title', 'vsc_get_cat_title_ajax_handler'); 
add_action('wp_ajax_nopriv_vsc_get_cat_title', 'vsc_get_cat_title_ajax_handler');
function vsc_get_cat_title_ajax_handler(){
